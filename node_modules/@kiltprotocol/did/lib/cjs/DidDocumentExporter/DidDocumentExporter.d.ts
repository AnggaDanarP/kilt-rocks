 ...
 */
import type { DidDocument, ConformingDidDocument } from '@kiltprotocol/types';
/**
 ...
 */
export declare function exportToDidDocument(did: DidDocument, mimeType: 'application/json' | 'application/ld+json'): ConformingDidDocument;
