...
import { Address } from './DidLinks/AccountLinks.chain.js';
/**
 * Web3Name is the type of nickname for a DID.
 */
export declare type Web3Name = string;
 ...
 */
export declare function linkedInfoFromChain(encoded: Option<RawDidLinkedInfo>, networkPrefix?: number): DidInfo;
