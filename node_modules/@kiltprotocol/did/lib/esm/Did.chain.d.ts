...
import type { Deposit, DidDocument, DidServiceEndpoint, DidUri, DidVerificationKey, KiltAddress, NewDidEncryptionKey, NewDidVerificationKey, SignExtrinsicCallback, SignRequestData, SignResponseData, SubmittableExtrinsic, UriFragment, VerificationKeyRelationship, BN } from '@kiltprotocol/types';
