...
import type { HexString, KeyringPair, KiltEncryptionKeypair, KiltKeyringPair } from '@kiltprotocol/types';
 ...
 */
export declare function naclBoxPairFromSecret(secret: Uint8Array): nacl.BoxKeyPair;
/**
