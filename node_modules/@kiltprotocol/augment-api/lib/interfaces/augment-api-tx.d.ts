...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        did: {
             ...
             **/
            createFromAccount: AugmentedSubmittable<(authenticationKey: DidDidDetailsDidVerificationKey | {
                ed25519: any;
            } | {
                sr25519: any;
            } | {
        ...
        didLookup: {
             ...
             **/
            associateAccount: AugmentedSubmittable<(req: PalletDidLookupAssociateAccountRequest | {
                Polkadot: any;
            } | {
                Ethereum: any;
            } | string | Uint8Array, expiration: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletDidLookupAssociateAccountRequest, u64]>;
            /**
             ...
             * See [`Pallet::change_deposit_owner`].
             **/
            changeDepositOwner: AugmentedSubmittable<(account: PalletDidLookupLinkableAccountLinkableAccountId | {
                AccountId20: any;
            } | {
                AccountId32: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletDidLookupLinkableAccountLinkableAccountId]>;
            /**
             * See [`Pallet::reclaim_deposit`].
             **/
            reclaimDeposit: AugmentedSubmittable<(account: PalletDidLookupLinkableAccountLinkableAccountId | {
                AccountId20: any;
            } | {
                AccountId32: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletDidLookupLinkableAccountLinkableAccountId]>;
             ...
             **/
            removeAccountAssociation: AugmentedSubmittable<(account: PalletDidLookupLinkableAccountLinkableAccountId | {
                AccountId20: any;
            } | {
                AccountId32: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletDidLookupLinkableAccountLinkableAccountId]>;
             ...
             * See [`Pallet::update_deposit`].
             **/
            updateDeposit: AugmentedSubmittable<(account: PalletDidLookupLinkableAccountLinkableAccountId | {
                AccountId20: any;
            } | {
                AccountId32: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletDidLookupLinkableAccountLinkableAccountId]>;
        ...
        migration: {
             ...
             **/
            updateBalance: AugmentedSubmittable<(requestedMigrations: PalletMigrationEntriesToMigrate | {
                attestation?: any;
                delegation?: any;
                did?: any;
                lookup?: any;
            ...
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletMigrationEntriesToMigrate]>;
        };
        multisig: {
            /**
        ...
        publicCredentials: {
             ...
             * See [`Pallet::add`].
             **/
            add: AugmentedSubmittable<(credential: PublicCredentialsCredentialsCredential | {
                ctypeHash?: any;
                subject?: any;
                claims?: any;
                authorization?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PublicCredentialsCredentialsCredential]>;
            /**
             * See [`Pallet::change_deposit_owner`].
             **/
             ...
             * See [`Pallet::remove`].
             **/
            remove: AugmentedSubmittable<(credentialId: H256 | string | Uint8Array, authorization: Option<RuntimeCommonAuthorizationPalletAuthorize> | null | Uint8Array | RuntimeCommonAuthorizationPalletAuthorize | {
                Delegation: any;
            } | string) => SubmittableExtrinsic<ApiType>, [H256, Option<RuntimeCommonAuthorizationPalletAuthorize>]>;
            /**
             * See [`Pallet::revoke`].
             **/
            revoke: AugmentedSubmittable<(credentialId: H256 | string | Uint8Array, authorization: Option<RuntimeCommonAuthorizationPalletAuthorize> | null | Uint8Array | RuntimeCommonAuthorizationPalletAuthorize | {
                Delegation: any;
            } | string) => SubmittableExtrinsic<ApiType>, [H256, Option<RuntimeCommonAuthorizationPalletAuthorize>]>;
            /**
             * See [`Pallet::unrevoke`].
             **/
            unrevoke: AugmentedSubmittable<(credentialId: H256 | string | Uint8Array, authorization: Option<RuntimeCommonAuthorizationPalletAuthorize> | null | Uint8Array | RuntimeCommonAuthorizationPalletAuthorize | {
                Delegation: any;
            } | string) => SubmittableExtrinsic<ApiType>, [H256, Option<RuntimeCommonAuthorizationPalletAuthorize>]>;
            /**
             * See [`Pallet::update_deposit`].
