...
exports.MetadataModel = exports.CTypeModel = exports.CTypeModelDraft01 = exports.CTypeModelV1 = void 0;
exports.CTypeModelV1 = {
    ...
    description: 'Describes a CType, which is a JSON schema for validating KILT claim types.',
    type: 'object',
    properties: {
...
exports.CTypeModelDraft01 = {
    $id: 'http://kilt-protocol.org/draft-01/ctype#',
    $schema: 'http://json-schema.org/draft-07/schema#',
    title: 'CType Metaschema (draft-01)',
    description: `Describes a CType, which is a JSON schema for validating KILT claim types. This version has known issues, the use of schema ${exports.CTypeModelV1.$id} is recommended instead.`,
    type: 'object',
    properties: {
        $id: {
            type: 'string',
...
exports.CTypeModel = {
    ...
    oneOf: [
        ...
        { $ref: exports.CTypeModelDraft01.$id },
            ...
            allOf: [
                // verifies that both of two (sub-)schemas validate against CType object.
                {
                    ...
                    properties: {
                        $schema: {
                            type: 'string',
                            const: exports.CTypeModelV1.$id,
                        },
                    },
                },
                {
                    // subschema 2: CType meta schema V1.
                    $ref: exports.CTypeModelV1.$id,
                },
            ],
        },
    ],
    ...
    definitions: {
        [exports.CTypeModelDraft01.$id]: exports.CTypeModelDraft01,
        [exports.CTypeModelV1.$id]: exports.CTypeModelV1,
    },
};
