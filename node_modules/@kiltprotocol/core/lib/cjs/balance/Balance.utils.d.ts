...
import type { BalanceNumber, BalanceOptions, MetricPrefix } from '@kiltprotocol/types';
export declare const KILT_COIN: BN;
export declare const Prefixes: Map<MetricPrefix, number>;
/**
 ...
 */
export declare function formatKiltBalance(amount: BalanceNumber, additionalOptions?: BalanceOptions): string;
/**
 ...
 */
export declare function convertToTxUnit(balance: BN, power: number): BN;
export declare const TRANSACTION_FEE: BN;
/**
 ...
 */
export declare function balanceNumberToString(input: BalanceNumber): string;
/**
 ...
 */
export declare function toFemtoKilt(input: BalanceNumber, unit?: MetricPrefix): BN;
/**
 ...
 */
export declare function fromFemtoKilt(input: BalanceNumber, decimals?: number, options?: BalanceOptions): string;
