...
import { CTypeModel, MetadataModel, CTypeModelDraft01, CTypeModelV1, } from './CType.schemas.js';
 ...
 */
export function fromProperties(title, properties, version = 'V1') {
    const schema = {
        properties,
        title,
