 ...
 */
import type { IDelegationHierarchyDetails, IDelegationNode } from '@kiltprotocol/types';
/**
 ...
 */
export declare function fetch(rootId: IDelegationNode['id']): Promise<IDelegationHierarchyDetails>;
